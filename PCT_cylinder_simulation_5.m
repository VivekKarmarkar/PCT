...
function generate_output_plots(input_struct, output_containers)
    ...
    path_img = "C:\Users\vkarmarkar\OneDrive - University of Iowa\Desktop\Research\Code\Test Code\STA_time_series_pose_v8\N=" + string(N) + "\";
...
function algorithm_containerPT = Perturbation_Theory_reprocessing(algorithm_containerPT)
    ...
    inertial_properties_perturbed = add_inertial_properties_perturbation(vectors_final, eigenvalues_final, inertiaTensor_final, inertial_properties_perturbed);
...
function inertial_properties_added = add_inertial_properties_perturbation(vectors_final, eigenvalues_final, inertiaTensor_final, inertial_properties_old)
...
function create_animation_RF(input_struct, output_containers, reference_frame_str)
    ...
    path_img = "C:\Users\vkarmarkar\OneDrive - University of Iowa\Desktop\Research\Code\Test Code\STA_time_series_pose_v8\N=" + string(input_struct.input_size.N) + "\";
