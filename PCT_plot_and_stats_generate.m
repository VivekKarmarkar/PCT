...
function plot_PCT_discontinuous_epsilon(input_size, final_output, display_flag)
    ...
    nexttile;
    plot(fraction_completed_gait_cycle, final_output(3).output_containers.mass_redistribution.PCTO(:,1), 'r', 'LineWidth', 1, 'DisplayName', 'm_1');
    hold on;
    plot(fraction_completed_gait_cycle, final_output(3).output_containers.mass_redistribution.PCTO(:,2), 'b', 'LineWidth', 2, 'DisplayName', 'm_2');
    plot(fraction_completed_gait_cycle, final_output(3).output_containers.mass_redistribution.PCTO(:,3), 'm', 'LineWidth', 1, 'DisplayName', 'm_3');
...
function plot_PCT_discontinuous_markerRatio(input_size, final_output, display_flag)
    ...
    hold on;
    scatter(fraction_completed_gait_cycle, final_output(5).output_containers.eps_star.PCTO - 1, 'b', 'LineWidth', 0.1, 'DisplayName', 'Epsilon - 1');
    plot(fraction_completed_gait_cycle, final_output(5).output_containers.mass_redistribution.PCTO(:,4), 'r', 'LineWidth', 1, 'DisplayName', 'm_4');
    plot(fraction_completed_gait_cycle, final_output(5).output_containers.mass_redistribution.PCTO(:,2), 'm', 'LineWidth', 1, 'DisplayName', 'm_2');
    plot(input_size.fraction_completed_gait_cycle, final_output(5).output_containers.CM_offset.PCTO, 'cyan', 'LineWidth', 1, 'DisplayName', 'CM');
    yL = ylim;
...
function final_output_mean = generate_ouput_stats(AFoffset_output, kneeAngle_output, input_size, NumConfigurations, display_flag)
    ...
    for n=1:NumKneeAngles
        ...
        %subplot(NumKneeAngles, 1, n);
        nexttile;
        xline(ToeOff, 'k', 'LineWidth', 1.5, 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle, final_output_mean.kneeAngle.REF(:,n), 'k', 'LineWidth', 1, 'DisplayName', 'REF');
        plot(fraction_completed_gait_cycle, final_output_mean.kneeAngle.SVDLS(:,n), 'm',  'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_mean.kneeAngle.PTUR(:,n), 'b',  'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_mean.kneeAngle.PCTO(:,n), 'r',  'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2, inBetween.kneeAngle.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2, inBetween.kneeAngle.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2(2:end-1), inBetween.kneeAngle.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
    ...
    xline(ToeOff, 'k', 'LineWidth', 1.5, 'DisplayName', 'Toe Off');
    hold on;
    plot(fraction_completed_gait_cycle, final_output_mean.AFoffset.thigh.SVDLS, 'm',  'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(fraction_completed_gait_cycle, final_output_mean.AFoffset.thigh.PTUR, 'b',  'LineWidth', 1, 'DisplayName', 'PCT-PT');
    plot(fraction_completed_gait_cycle, final_output_mean.AFoffset.thigh.PCTO, 'r',  'LineWidth', 1, 'DisplayName', 'PCT');
    fill(x2, inBetween.AFoffset.thigh.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
    fill(x2, inBetween.AFoffset.thigh.PTUR, 'b', 'FaceAlpha', 0.2, 'EdgeColor', 'b', 'HandleVisibility', 'off');
    fill(x2(2:end-1), inBetween.AFoffset.thigh.PCTO(2:end-1), 'r', 'FaceAlpha', 0.2, 'EdgeColor', 'r', 'HandleVisibility', 'off');
    ...
    xline(ToeOff, 'k', 'LineWidth', 1.5, 'DisplayName', 'Toe Off');
    hold on;
    plot(fraction_completed_gait_cycle, final_output_mean.AFoffset.shank.SVDLS, 'k',  'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(fraction_completed_gait_cycle, final_output_mean.AFoffset.shank.PTUR, 'b',  'LineWidth', 1, 'DisplayName', 'PTUR');
    plot(fraction_completed_gait_cycle, final_output_mean.AFoffset.shank.PCTO, 'r',  'LineWidth', 1, 'DisplayName', 'PCTO');
    fill(x2, inBetween.AFoffset.shank.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
    fill(x2, inBetween.AFoffset.shank.PTUR, 'b', 'FaceAlpha', 0.2, 'EdgeColor', 'b', 'HandleVisibility', 'off');
    fill(x2(2:end-1), inBetween.AFoffset.shank.PCTO(2:end-1), 'r', 'FaceAlpha', 0.2, 'EdgeColor', 'r', 'HandleVisibility', 'off');
    fill([0 0.6 0.6 0], [0 0 4 4], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    grid;
    xlabel("Fraction completed gait cycle");
    ylabel("Error (cm)");
...
function final_output_thigh_mean = generate_ouput_stats_thigh(final_output, input_size, display_flag)
    ...
    hold on;
    plot(fraction_completed_gait_cycle, final_output_thigh_mean.CM_offset.SVDLS, 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(fraction_completed_gait_cycle, final_output_thigh_mean.CM_offset.PTUR, 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
    plot(fraction_completed_gait_cycle, final_output_thigh_mean.CM_offset.PCTO, 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
    fill(x2, inBetween.CM_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
    fill(x2, inBetween.CM_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
    fill(x2(2:end-1), inBetween.CM_offset.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
    ...
    for n=1:input_size.N
        ...
        xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.cluster_offset.SVDLS(:,n), 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.cluster_offset.PTUR(:,n), 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.cluster_offset.PCTO(:,n), 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2, inBetween.cluster_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2, inBetween.cluster_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2(2:end-1), inBetween.cluster_offset.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
        fill([0 0.6 0.6 0], [0 0 4 4], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
        ylim([0, 4]);
        grid;
        if n==2
    ...
    for n=1:input_size.Num_AL_Thigh
        ...
        xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.AL_offset.SVDLS(:,n), 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.AL_offset.PTUR(:,n), 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.AL_offset.PCTO(:,n), 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2_short, inBetween.AL_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2_short, inBetween.AL_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2_short, inBetween.AL_offset.PCTO, 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
        fill([0 0.6 0.6 0], [0 0 4 4], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
        ylim([0, 4]);
        grid;
        if n==2
    ...
    for n=1:NumEigenvectors
        ...
        xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle(2:end), final_output_thigh_mean.eigenvector_offset.SVDLS(2:end,n), 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.eigenvector_offset.PTUR(:,n), 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_thigh_mean.eigenvector_offset.PCTO(:,n), 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2_short, inBetween.eigenvector_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2_short, inBetween.eigenvector_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2_short, inBetween.eigenvector_offset.PCTO, 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
...
function final_output_shank_mean = generate_ouput_stats_shank(final_output_shank, input_size, display_flag)
    ...
    xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
    hold on;
    plot(fraction_completed_gait_cycle, final_output_shank_mean.CM_offset.SVDLS, 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(fraction_completed_gait_cycle, final_output_shank_mean.CM_offset.PTUR, 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
    plot(fraction_completed_gait_cycle, final_output_shank_mean.CM_offset.PCTO, 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
    fill(x2, inBetween.CM_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
    fill(x2, inBetween.CM_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
    fill(x2(2:end-1), inBetween.CM_offset.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
    fill([0 0.6 0.6 0], [0 0 3.5 3.5], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ...
    for n=1:input_size.N
        ...
        xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle, final_output_shank_mean.cluster_offset.SVDLS(:,n), 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_shank_mean.cluster_offset.PTUR(:,n), 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_shank_mean.cluster_offset.PCTO(:,n), 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2, inBetween.cluster_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2, inBetween.cluster_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2(2:end-1), inBetween.cluster_offset.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
        fill([0 0.6 0.6 0], [0 0 4 4], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ...
    for n=1:input_size.Num_AL_Shank
        ...
        %subplot(2, input_size.Num_AL_Shank/2, n);
        nexttile;
        xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle, final_output_shank_mean.AL_offset.SVDLS(:,n), 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_shank_mean.AL_offset.PTUR(:,n), 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_shank_mean.AL_offset.PCTO(:,n), 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2, inBetween.AL_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2, inBetween.AL_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2(2:end-1), inBetween.AL_offset.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
        fill([0 0.6 0.6 0], [0 0 4 4], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
        ylim([0, 4]);
        grid;
        if n==2
    ...
    for n=1:NumEigenvectors
        ...
        xline(ToeOff, 'k--', 'DisplayName', 'Toe Off');
        hold on;
        plot(fraction_completed_gait_cycle, final_output_shank_mean.eigenvector_offset.SVDLS(:,n), 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
        plot(fraction_completed_gait_cycle, final_output_shank_mean.eigenvector_offset.PTUR(:,n), 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
        plot(fraction_completed_gait_cycle, final_output_shank_mean.eigenvector_offset.PCTO(:,n), 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
        fill(x2, inBetween.eigenvector_offset.SVDLS, 'm', 'FaceAlpha', 0.2, 'EdgeColor', 'm', 'HandleVisibility', 'off');
        fill(x2, inBetween.eigenvector_offset.PTUR, 'blue', 'FaceAlpha', 0.2, 'EdgeColor', 'blue', 'HandleVisibility', 'off');
        fill(x2(2:end-1), inBetween.eigenvector_offset.PCTO(2:end-1), 'red', 'FaceAlpha', 0.2, 'EdgeColor', 'red', 'HandleVisibility', 'off');
        fill([0 0.6 0.6 0], [0 0 10 10], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
        ylim([0, 10]);
        grid;
        if n==1
...
function generate_output_plots_thigh(input_struct, output_containers_thigh)
    ...
    for n=1:length(alg_list)
        ...
        if current_alg == "PTNR"
            scatter(fraction_completed_gait_cycle, current_data, color_list(n), 'LineWidth', 1, 'DisplayName', current_alg_legend_name);
        else
            plot(fraction_completed_gait_cycle, current_data, color_list(n), 'LineWidth', 1, 'DisplayName', current_alg_legend_name);
        end
    end
    yL =  ylim;
    ...
    for j=1:3
        ...
        for n=1:length(alg_list)
            ...
            plot(fraction_completed_gait_cycle, current_data(:,j), color_list(n), 'LineWidth', 1, 'DisplayName', current_alg_legend_name);
        end
        yL =  ylim;
        fill([0 0.6 0.6 0], [yL(1) yL(1) yL(2) yL(2)], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
        ylim(yL);
    ...
    for j=1:4
        ...
        for n=1:length(alg_list)
            ...
            if current_alg == "PTNR"
                scatter(fraction_completed_gait_cycle, current_data(:,j), color_list(n), 'LineWidth', 1, 'DisplayName', current_alg_legend_name);
            else
                plot(fraction_completed_gait_cycle, current_data(:,j), color_list(n), 'LineWidth', 1, 'DisplayName', current_alg_legend_name);
            end
        end
...
function AFoffset = generate_AL_origin_offset_plot(output_container_current_PCT, input_struct)
    ...
    hold on;
    plot(input_size.fraction_completed_gait_cycle, thigh_offset.SVDLS, 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(input_size.fraction_completed_gait_cycle, thigh_offset.PTUR, 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
    plot(input_size.fraction_completed_gait_cycle, thigh_offset.PCTO, 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
    yL =  ylim;
    fill([0 0.6 0.6 0], [yL(1) yL(1) yL(2) yL(2)], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ylim(yL);
    grid;
    ...
    xline(0.6, 'k--', 'DisplayName', 'ToeOff');
    hold on;
    plot(input_size.fraction_completed_gait_cycle, shank_offset.SVDLS, 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(input_size.fraction_completed_gait_cycle, shank_offset.PTUR, 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
    plot(input_size.fraction_completed_gait_cycle, shank_offset.PCTO, 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
    yL =  ylim;
    fill([0 0.6 0.6 0], [yL(1) yL(1) yL(2) yL(2)], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ylim(yL);
    grid;
...
function generate_knee_angle_plot(knee_angle_current, input_struct)
    ...
    xline(0.6, 'k--', 'DisplayName', 'ToeOff');
    hold on;
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.reference.flexion, 'k', 'LineWidth', 1, 'DisplayName', 'Reference');
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.SVDLS.flexion, 'm', 'LineWidth', 1, 'DisplayName', 'SVD-LS');
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.PTUR.flexion, 'b', 'LineWidth', 1, 'DisplayName', 'PCT-PT');
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.PCTO.flexion, 'r', 'LineWidth', 1, 'DisplayName', 'PCT');
    yL =  ylim;
    fill([0 0.6 0.6 0], [yL(1) yL(1) yL(2) yL(2)], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ylim(yL);
    ...
    xline(0.6, 'k--');
    hold on;
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.reference.adduction, 'k', 'LineWidth', 1);
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.SVDLS.adduction, 'm', 'LineWidth', 1);
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.PTUR.adduction, 'b', 'LineWidth', 1);
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.PCTO.adduction, 'r', 'LineWidth', 1);
    yL =  ylim;
    fill([0 0.6 0.6 0], [yL(1) yL(1) yL(2) yL(2)], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ylim(yL);
    ylabel("degrees");
    ...
    xline(0.6, 'k--');
    hold on;
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.reference.externalRotation, 'k', 'LineWidth', 1);
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.SVDLS.externalRotation, 'm', 'LineWidth', 1);
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.PTUR.externalRotation, 'b', 'LineWidth', 1);
    plot(input_size.fraction_completed_gait_cycle, knee_angle_current.estimated.PCTO.externalRotation, 'r', 'LineWidth', 1);
    yL =  ylim;
    fill([0 0.6 0.6 0], [yL(1) yL(1) yL(2) yL(2)], 'k', 'FaceAlpha', 0.05, 'HandleVisibility', 'off');
    ylim(yL);
    ylabel("degrees");
